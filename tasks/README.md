...
| [11](active/STEP-11-forward-observation.md) | Run and mature the forward shadow trial (complete) | Commit real decisions prospectively after software, data and participants are ready; then let horizons elapse. | 015 |
