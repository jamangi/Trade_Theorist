# Historical task index — superseded as the execution queue

Snapshot of the META-001 queue at b60f301. Use [ordered remaining work](README.md) for implementation. Old dependencies and next-task wording below are historical, not the active sequence.
