...
**Offline rate preflight:** after 014 implements the [request-budget contract](../docs/market-data-request-budget.md), verify it with fake clocks and recorded transports before any account-backed sample or run. This narrow subgate needs 014's new software and the existing fixture controls from 015, not vendor qualification or completed real forward sessions. Record a distinct preflight pass/fail artifact; it is not full TASK-016 completion or paper promotion.
