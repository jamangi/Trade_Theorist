...
> Historical task ID, retained for traceability. Remaining work is governed by [Step 17](active/STEP-17-disclosures.md). Original status and evidence below describe the earlier scope; old dependencies and next-task wording are not the active execution order.
