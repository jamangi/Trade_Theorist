...
**Pending Steps 04–05:** usable private commands and hardened loopback serving with browser/path/origin restrictions. Only original synthetic bundles are browser-previewed in Step 03; real private serving awaits those controls. No automatic public publishing is enabled. Source rights, publication class and information-regime contamination are separate dimensions. Do not overload `contamination=fixture` as a license grant.
